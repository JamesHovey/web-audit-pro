  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col" onMouseDown={(e) => e.stopPropagation()}>
        {/* Header */}
        <div className="flex items-center justify-between p-6 bg-black text-white rounded-t-lg">
          <div className="flex items-center gap-3">
            <Settings className="w-6 h-6 text-white" />
            <div>
              <h2 className="text-2xl font-semibold" style={{ color: 'white' }}>Settings</h2>
              <p className="text-blue-100">API configuration and status</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-3 py-2 bg-[#42499c] hover:bg-[#353f85] disabled:bg-[#42499c] disabled:opacity-50 text-white rounded-lg transition-colors text-sm font-medium"
              title="Refresh data"
            >
